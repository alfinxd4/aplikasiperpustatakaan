                    ...
                    <div class="page-content ">
                        ...
                        <section class="section">
                            <div class="card">
                                        ...
                                        <div class="col-md-6  mt-3 mt-md-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mt-3 mt-md-0">
                                                    <button id="cariPinjaman" class="btn btn-primary">Cari</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body" id="tampilPinjaman">
        ...
        $(document).ready(function() {
            ...
            $("#cariPinjaman").click(function() {
                ...
                if (tanggal1 == "") {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('laporan/data_pinjam'); ?>",
                        type: "POST",
                        data: "tanggal1=" + tanggal1 + "&tanggal2=" + tanggal2,
                        cache: false,
                        success: function(html) {
                            $("#tampilPinjaman").html(html);
                        }
                    })
                }
            });
